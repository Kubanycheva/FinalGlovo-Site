# Generated by Django 5.1.3 on 2024-12-04 08:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_orders', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='delivery_app.order')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.PositiveSmallIntegerField()),
                ('description', models.TextField()),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='combos', to='delivery_app.store')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='store_reviews', to='delivery_app.store')),
            ],
        ),
    ]
